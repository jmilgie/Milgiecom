...
export default {
  ...
  instruments: {
    ...
    wPad: { base: 'padDark', r: 1.0 },                                              // play-time: shorter tails keep the voice count low
    wChoir: { base: 'choirOh', r: 0.9 },
  ...
  channels: {
    ...
    snare: { inst: 'snareBig', gain: 0.5, reverb: 0.26, poly: 2, layer: { min: 0.15 } },
    hat: { gain: 0.34, pan: 0.24, choke: ['ohat'], human: { t: 0.002, v: 0.1 }, poly: 2, layer: { min: 0.15 } },
    ohat: { gain: 0.26, pan: 0.28, poly: 1, layer: { min: 0.15 } },
    rim: { gain: 0.3, pan: -0.22, delay: 0.12, poly: 1 },
    clank: { gain: 0.3, pan: 0.3, reverb: 0.42, delay: 0.18, note: 'C4', poly: 2 },
    ride: { gain: 0.2, pan: -0.3, poly: 1 },
    crash: { gain: 0.4, reverb: 0.15, pan: -0.18, poly: 1 },
    tom: { gain: 0.34, reverb: 0.16, poly: 1 },
    taiko: { gain: 0.2, reverb: 0.24, tune: -2, poly: 2 },
    tkm: { inst: 'taiko', gain: 0.25, reverb: 0.2, pan: 0.12, poly: 2 },
    tk2: { inst: 'taiko', gain: 0.22, reverb: 0.22, pan: -0.16, poly: 2, layer: { min: 0.75 } },
    rev: { inst: 'revcym', gain: 0.42 },
    riser: { gain: 0.4, reverb: 0.3 },
    down: { inst: 'downlifter', gain: 0.38, reverb: 0.35 },
    impact: { gain: 0.45, reverb: 0.28, poly: 1 },
    sub: { gain: 0.55 },
    reese: { gain: 0.42, lpf: 20000 },
    bass: { inst: 'wBass', gain: 0.68, duck: 0.35, lpf: 20000 },
    pad: { inst: 'wPad', gain: 0.27, duck: 0.45, reverb: 0.35, lpf: 20000, hpf: 160, poly: 6 },
    spicc: { inst: 'wSpicc', gain: 0.46, reverb: 0.22, pan: 0.2, duck: 0.25, poly: 4 },
    cello: { inst: 'stringsDark', gain: 0.5, reverb: 0.3, pan: -0.12, poly: 3 },
    brass: { gain: 0.4, reverb: 0.3, poly: 6 },
    stab: { inst: 'brassStab', gain: 0.44, reverb: 0.24, pan: -0.08, delay: 0.1, hpf: 110, poly: 4 },
    horn: { inst: 'brass', gain: 0.78, reverb: 0.3, pan: 0.06, poly: 2 },
    choir: { inst: 'wChoir', gain: 0.24, reverb: 0.5, duck: 0.2, poly: 5 },
    arp: { inst: 'wArp', gain: 0.3, delay: 0.32, reverb: 0.15, pan: -0.3, duck: 0.3, poly: 3 },
  ...
  patterns: {
    ...
    b2Down: { len: 128, down: [[108, 'x', 20, 0.5]] },                                    // falling into the break

    // ── BREAK: into the belly ──
    brkHit: { impact: 'X', crash: 'x' },
  ...
  sections: {
    ...
    B2: {
      ...
      play: ['themeB2', 'descB2', 'choirB2', 'ostB', 'padB', 'arpB2', 'stabB', 'rideB2', ['crash1', null, null, null, 'crash1', null, null, null],
        ['grB', 'grB', 'grB', 'fillB', 'grB', 'grB', 'grB', 'fillB2'], 'tkB', 'tk2B', { p: 'b2Down', once: true }],
      auto: { 'lead.vol': [[0, 0.62]], 'pad.vol': [[0, 0.7]], 'pad.lpf': [[0, 1800]] },
    },
    break: {
      bars: 8, chords: BRK_H,
      play: ['brkPad', { p: 'brkHit', once: true }, { p: 'brkDrone', once: true }, 'brkCello', { p: 'brkChoir', once: true }, { p: 'brkBeacon', once: true }, { p: 'brkTick', until: 4 },
