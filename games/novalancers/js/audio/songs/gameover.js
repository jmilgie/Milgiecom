...
export default {
  ...
  channels: {
    ...
    violin: { inst: 'gStr', gain: 0.5, reverb: 0.55, delay: 0.1, pan: 0.08 },
    strings: { inst: 'stringsDark', gain: 0.34, reverb: 0.5, pan: -0.12 },
    oo: { inst: 'choirOo', gain: 0.3, reverb: 0.6 },
    pad: { inst: 'gPad', gain: 0.4, reverb: 0.5, lpf: 1600 },
    keys: { inst: 'gKeys', gain: 0.44, reverb: 0.5, pan: -0.1 },
    drone: { inst: 'bassSoft', gain: 0.42 },
    glass: { inst: 'gGlass', gain: 0.3, reverb: 0.6, delay: 0.45, pan: 0.25 },
