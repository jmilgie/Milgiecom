...
export default {
  ...
  instruments: {
    hBass: { base: 'bass', cutoff: 560, env: 2.2, fd: 0.14, q: 3, drive: 0.4, d: 0.16, s: 0.62 },
    hGate: { base: 'padBright', a: 0.003, d: 0.09, s: 0.72, r: 0.045 },        // play-time only: shares padBright
    hRiff: { base: 'lead', wave: 'saw', voices: 5, detune: 20, cutoff: 1400, kt: 0.4, q: 2.5, env: 1.9, fa: 0.003, fd: 0.22, vib: 0, a: 0.002, d: 0.25, s: 0.55, r: 0.12, glide: 0, vol: 0.55 },
  ...
  channels: {
    kick: { gain: 0.42, sidechain: true, lpf: 20000, layer: { min: 0.15 } },
    clap: { gain: 0.7, reverb: 0.22, layer: { min: 0.15 } },
    snare: { inst: 'snareTight', gain: 0.34, reverb: 0.2 },
    hat: { gain: 0.3, pan: 0.22, human: { t: 0.002, v: 0.12 }, layer: { min: 0.15 } },
    ohat: { gain: 0.3, pan: -0.18, layer: { min: 0.15 } },
    ride: { gain: 0.2, pan: 0.3, layer: { min: 0.7 } },
    crash: { gain: 0.4, reverb: 0.18, pan: -0.15 },
    ...
    vast: { inst: 'padGlass', gain: 0.3, reverb: 0.45, duck: 0.35, lpf: 20000 },
    pad: { gain: 0.24, reverb: 0.3, duck: 0.55, lpf: 20000 },
    gate: { inst: 'hGate', gain: 0.46, reverb: 0.2, delay: 0.1, duck: 0.4, lpf: 20000 },
    strings: { gain: 0.36, reverb: 0.4, pan: 0.16, duck: 0.25 },
    choirOo: { gain: 0.24, reverb: 0.55, duck: 0.2 },
    choir: { gain: 0.24, reverb: 0.5, duck: 0.25 },
    brass: { gain: 0.62, reverb: 0.3, pan: -0.06 },
    riff: { inst: 'hRiff', gain: 1.2, delay: 0.3, reverb: 0.2, pan: 0.08, duck: 0.3, lpf: 20000 },
    arp: { inst: 'hArp', gain: 0.32, delay: 0.3, reverb: 0.18, pan: -0.28, duck: 0.35, lpf: 20000 },
    keys: { gain: 0.42, reverb: 0.4, delay: 0.18 },
    keysL: { inst: 'keys', gain: 0.28, reverb: 0.4, pan: -0.15 },
    glass: { gain: 0.26, reverb: 0.55, delay: 0.35, pan: 0.3 },
  ...
  patterns: {
    ...
    arpA: { len: 128, arp: arp(voiceLead(A_H.split(' '), { low: 'B4', high: 'B5', voices: 3 }), { rate: 1, oct: 2, order: [0, 1, 2, 3, 4, 5, 4, 3, 1, 2, 3, 4, 5, 4, 3, 2], vel: 0.6, accent: 0.18 }) },
    dA: { kick: 'X...X...X...X...', clap: '....x.......x...', hat: '.g.o.g.o.g.o.g.o', ohat: '..x...x...x...x.' },
    ...
    melB: { step: 2, lead: HMEL, lead2: HMEL.replace(/([A-G]#?)(\d)/g, (m, n, o) => n + (o - 1)) },
    ...
    arpB: { len: 128, arp: arp(voiceLead(halves(B_H), { low: 'B4', high: 'B5', voices: 3 }), { rate: 1, len: 8, continue: true, oct: 2, order: [0, 2, 1, 3, 2, 4, 3, 5], vel: 0.58, accent: 0.18 }) },
    ...
    brkStrings: { len: 128, strings: chordEvents(THEME_H, { low: 'A3', high: 'F#5', voices: 4, vel: 0.55 }) },
    ...
    clxArp: { len: 256, arp: arp(voiceLead(halves(THEME_H + ' ' + CLX2_H), { low: 'B4', high: 'B5', voices: 3 }), { rate: 1, len: 8, continue: true, oct: 2, order: [0, 1, 2, 3, 4, 5, 4, 3], vel: 0.56, accent: 0.18 }) },
